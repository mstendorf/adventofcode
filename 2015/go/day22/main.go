...
// this is not entirely my code, had some trouble getting bfs to work so took inspiration from this
// monty python approach to the problem
import (
	"fmt"
	"math/rand"
	"time"
